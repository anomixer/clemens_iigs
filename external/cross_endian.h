...
/* minimal windows includes if possible for minimal functionality*/
...
#else
#pragma message("Quick endian check not supported for this architecture - please add it here!")
#define BYTE_ORDER LITTLE_ENDIAN
#endif
